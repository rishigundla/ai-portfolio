...
| **Current Day** | Week 5 · Day 6.2 — Project 1 Categories A + B CLOSED (`v1.0-dashboard-factory` tagged) |
...
| **Blockers** | None for shipping. **3 tracked follow-ups** before Project 1 is "really done" — see [Project 1 — Pending Follow-ups](#project-1-dashboard-factory--pending-follow-ups) section below. |
...
## Project 1 (Dashboard Factory) — Pending Follow-ups

**Status**: Functionally closed as of W5.D6 (2026-05-14) — production live, case study shipped, READMEs polished, portfolioCard aligned, cross-viewport QA verified. Items below are tracked but did not block close.
...
- More datasets — HR analytics (cohort tables), security operations (log timelines), e-commerce (purchase funnels). Each stress-tests a chart kind the existing six don't
- ML-driven KPI suggestions — replace hand-curated profiling fixtures with a model that consumes schema + sample rows and synthesizes the profile text
- Multi-user persistence — save dashboards, share via URL. Today everything is client-state in Zustand
- Custom domain mapping for the live demo and case study
